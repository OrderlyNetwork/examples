        ...
        <Flex gap="2" align="stretch" justify="center" direction="column">
          <label>
            ...
            <TextField.Root style={{ gridArea: 'input' }}>
              <TextField.Input type="number" step="0.1" min="2000" name="order_price" />
            </TextField.Root>
          </label>
          ...
          <label>
            Amount (ETH):
            <TextField.Root style={{ gridArea: 'input' }}>
              <TextField.Input type="number" step="0.01" min="0" name="order_quantity" />
            </TextField.Root>
          </label>
          ...
          <label>
            ...
            <Select.Root defaultValue={OrderType.LIMIT} name="order_type">
              ...
              <Select.Content>
                <Select.Item value={OrderType.LIMIT}>{OrderType.LIMIT}</Select.Item>
                <Select.Item value={OrderType.MARKET}>{OrderType.MARKET}</Select.Item>
              </Select.Content>
            </Select.Root>
          </label>
          ...
          <label>
            ...
            <Select.Root defaultValue={OrderSide.BUY} name="side">
              ...
              <Select.Content>
                ...
                <Select.Item value={OrderSide.SELL}>{OrderSide.SELL}</Select.Item>
              </Select.Content>
            </Select.Root>
          </label>
